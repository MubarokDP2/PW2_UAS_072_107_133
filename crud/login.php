...
<style>
    body {
      background-color: #984d11; /* Warna cokelat terang */
      color: #333;
    }
    ...
    .container {
      ...
      background-color: #d2b48c; /* Warna cokelat terang */
    }
    ...
    .welcome-text {
      ...
      font-weight: bold;
      margin-bottom: 20px;
      background-color: #be4900; /* Warna cokelat terang */
      padding: 10px;
      border-radius: 10px;
    }
  </style>
...
<body>
  <div class="container">
    <div class="row min-vh-100 justify-content-center align-items-center">
      <div class="col-lg-5">
      <div class="welcome-text">Selamat Datang di Website ListBukumu</div>
        <?php
        if (!empty($login_err)) {
